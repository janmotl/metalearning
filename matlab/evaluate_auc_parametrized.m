...
function [classificationError, features] = evaluate_auc_parametrized(databaseName, terminationThreshold, alpha)
...
%     x = remove_almost_null(x);
    ...
    % Progress
    display([i features(i) classificationError(i) nextFeature.fitness_prediction])
